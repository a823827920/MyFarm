        ...
        <form class="layui-form" action="" method="get">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="field_id" lay-verify="required|required"  autocomplete="off"  class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="insect_state" lay-verify="required"  autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form', 'layedit', 'laydate','upload'], function(){
        ...
        form.on('submit(formDemo)', function(data){
            var $=layui.$;
            $.ajax({
                url: '${pageContext.request.contextPath}/AddNewDiary',
                type: 'post',
                async:false,
                data: {
